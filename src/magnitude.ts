/**
 * Signed/unsigned magnitude reinterpretation: the samplers' arithmetic.
 ...
 */
/**
 * The unsigned magnitude of a signed integer: `Math.abs`, except `MIN` wraps
 * to its own absolute value instead of overflowing (Rust's `wrapping_abs`).
 *
 * @internal
 */
